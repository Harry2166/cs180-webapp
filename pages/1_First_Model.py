...
bert_params = "{'learning_rate': 3.8475631894852275e-06, 'batch_size': 4, 'num_train_epochs': 20, 'fp16': True}"
st.image(os.path.abspath("../cs180-webapp/images/bert_model_loss.png"), caption="Results of the Chosen BERT Model Parameters")
st.write(f"The parameters that were chosen for the fine-tuend BERT model that were generated by Optuna are the following: {bert_params}\nEpoch 3 was the selected epoch from the generated results because it contained the least validation loss out of all the trials & epochs.")
